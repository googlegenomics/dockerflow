...
public interface DockerflowConstants {
  ...
  String DOCKERFLOW_WORKSPACE = "DOCKERFLOW_WORKSPACE";
  String DOCKERFLOW_PROJECT = "DOCKERFLOW_PROJECT";
  String DOCKERFLOW_TEST = "DOCKERFLOW_TEST";
  String DOCKERFLOW_ZONES = "DOCKERFLOW_ZONES";
